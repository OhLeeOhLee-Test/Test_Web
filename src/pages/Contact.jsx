      ...
      <div className="profile-section">
        ...
        <div className="contact-card">
          <div className="contact-item">
            ...
            <span className="value">Fluid Dynamics (Drop Impact, Worthington Jets), Pure Mathematics (Number Theory)</span>
          </div>
          <div className="contact-item">
            <span className="label">Tech Stack</span>
            <span className="value">CATIA, SolidWorks, ImageJ, CFD, AutoHotkey</span>
          </div>
          <div className="contact-item">
